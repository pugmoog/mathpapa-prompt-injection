(function () {
  ...
  var ACTION_HELP_PAGES = [
    ...
    `HELP 8/8 — Finishing and recovery. Finish with [ACTION {"name":"message user"}]your final explanation. Its body is displayed and the run stops. Continue message no longer exists; actionless responses continue automatically. [ACTION {"name":"help"}] replays this guide. Failed, malformed, or unsupported actions point to help and the run continues. Markdown works. Activity rows show edits, reads, runs, and failures. NEVER exceed 4000 chars. Do not act yet; reply exactly next.`
  ];
